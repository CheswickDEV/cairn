...
Trigger: the user says **"Cairn resume"** (or invokes `/cairn-resume`), or you are picking up prior work.
...
4. Optional: call `context_status` to see the current zone. If you need a value byte-exact that the
